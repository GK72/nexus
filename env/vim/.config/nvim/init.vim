...
source ~/nxs/env/vim/.config/nvim/arrownavigation.vim
source ~/nxs/env/vim/.config/nvim/dragvisuals.vim
source ~/nxs/env/vim/.config/nvim/vmath.vim
source ~/nxs/env/vim/.config/nvim/functions.vim
