...
elseif(SANITIZERS STREQUAL "tsan")
...
if(SANITIZERS)
    if(SANITIZERS STREQUAL asan)
        set(SANITIZER_LIST "-fsanitize=address -fsanitize=leak -fsanitize=undefined")
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${SANITIZER_LIST}")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${SANITIZER_LIST}")
        message("Sanitizers turned on: ${SANITIZER_LIST}")
    endif()
